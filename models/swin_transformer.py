...
class Input_Extracter(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        print("SwinTransformerSys expand initial----depths:{};drop_path_rate:{};num_classes:{}".format(depths,
                                                                                                       drop_path_rate,
                                                                                                       num_classes))
        self.img_size = img_size
...
class MSTI_Block(nn.Module):
    def __init__(self, img_size=(112, 224), patch_size=(2, 4), in_chans=3, num_classes=1000,
        ...
        print(
            "MSTI_Block expand initial----depths:{};drop_path_rate:{};num_classes:{}".format(
...
class MSTO_Block(nn.Module):
    def __init__(self, img_size=(112, 224), patch_size=(2, 4), in_chans=3, num_classes=3,
        ...
        print(
            "MSTO_Block expand initial----depths:{};drop_path_rate:{};num_classes:{}".format(
                depths, drop_path_rate, num_classes))
